export const signUpErrMaps: Record<string, Record<string, string> | string> = {
  INVALID_DATA: {
    "name: Too small: expected string to have >=1 characters": "A name is required.",
    "email: Invalid email address": "A valid email address is required.",
    "image: Invalid URL": "A valid image URL is required.",
    "password: Too small: expected string to have >=8 characters": "A password is required.",
...
export const verifyEmailErrMaps: Record<string, Record<string, string> | string> = {
  INVALID_DATA: "The token is invalid.",
  TOKEN_EXPIRED: "The token has expired. Try signing in again to get a new one.",
...
export const signInErrMaps: Record<string, Record<string, string> | string> = {
  ...
  EMAIL_NOT_VERIFIED: "This email isn't verified. Check your inbox for a verification email.",
  UNPROCESSABLE_ENTITY: "Please check your input and try again.",
...
export const resetPwdErrMaps: Record<string, Record<string, string> | string> = {
  INVALID_DATA: {
    "newPassword: Too small: expected string to have >=8 characters": "A new password is required.",
    "token: Too small: expected string to have >=1 characters": "A valid token is required.",
    "token: Invalid input: expected string, received undefined": "A valid token is required.",
    default: "Please check your input and try again.",
  },
