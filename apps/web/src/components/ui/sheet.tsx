  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-background shadow-lg outline-0 transition ease-in-out outline-none data-[state=closed]:duration-200 data-[state=closed]:animate-out data-[state=open]:duration-300 data-[state=open]:animate-in",
          side === "right" &&
