...
const InputAddon = ({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 end-0 flex h-full w-8 items-center justify-center rounded-e-lg text-neutral-600 transition-[color,box-shadow] outline-none focus:z-10 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 lg:hover:text-neutral-700 dark:text-neutral-400 dark:lg:hover:text-neutral-200",
...
const InputError = ({
  ...
  return (
    <p
      className={cn("mt-1 text-xs text-red-600 dark:text-red-500", className)}
